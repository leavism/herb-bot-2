...
module.exports = class extends Monitor {
  ...
  async run (message) {
    ...
    if (customCommands[commandText]) {
      return this.runCustomCommand(message, commandText)
    }
    if (!command) {
  ...
  runCustomCommand (message, commandText) {
    message.send(customCommands[commandText])
  }
